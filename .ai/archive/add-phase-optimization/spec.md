...
- THEN it includes clear extraction scope, exclusions for assistant content, speculative content, transient troubleshooting noise, and externally attributed advice, plus at least one positive and one negative example
