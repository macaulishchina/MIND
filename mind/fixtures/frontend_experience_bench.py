...
def build_frontend_experience_bench_v1() -> list[FrontendExperienceScenario]:
    ...
    scenarios = [
        ...
        FrontendExperienceScenario(
            ...
            "desktop",
            False,
            "Desktop config view can read backend/profile state without mutating runtime implicitly.",
        ),
        FrontendExperienceScenario(
            ...
            "mobile",
            False,
            "Mobile config view keeps backend/profile edits explicit and reviewable.",
        ),
        FrontendExperienceScenario(
            ...
            "desktop",
            False,
            "Desktop config view can inspect provider/model state and missing-auth status.",
        ),
        FrontendExperienceScenario(
            ...
            "desktop",
            False,
            "Desktop config view exposes dev-mode as an explicit switch, not a hidden side effect.",
        ),
        FrontendExperienceScenario(
            "config_recovery_mobile",
            "config",
            "config_restore",
            "mobile",
            False,
            "Mobile config flow can recover to the last explicit configuration snapshot.",
        ),
        FrontendExperienceScenario(
