...
from mind.eval import evaluate_workspace_ablation_run
...
def test_phase_f_workspace_ablation_passes_current_thresholds_for_cross_episode_pair_chunk(
    chunk_name: str,
    sequence_ids: tuple[str, ...],
    run_id: int,
) -> None:
    assert chunk_name
    interval = evaluate_workspace_ablation_run(
        run_id=run_id,
