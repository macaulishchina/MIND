...
def test_extract_stl_from_message(message: str):
    return global_memory._extract_stl(message)

def test_extract_stl_from_file(file_path: str):
    with open(file_path, "r") as f:
        lines = f.readlines()
        return [test_extract_stl_from_message(line.strip()) for line in lines]
